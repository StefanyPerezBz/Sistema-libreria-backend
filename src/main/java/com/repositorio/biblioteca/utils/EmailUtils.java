...
public class EmailUtils {
    ...
    public void forgotMail(String to, String subject, String password) throws MessagingException {
        ...
        String htmlMsg = "<p><b>Sus datos de acceso para el Sistema de Gestión de la Biblioteca</b><br>"
                + "<b>Correo electrónico: </b> " + to + "<br>"
                + "<b>Contraseña: </b> " + password + "<br>"
                + "<a href=\"http://localhost:4200/\">Haga clic aquí para iniciar sesión</a></p>";
